...
export function Container({
  ...
  return (
    <div className={`mx-auto w-full max-w-[1400px] px-5 sm:px-6 lg:px-10 ${className}`}>
      {children}
    </div>
  );
}
...
export function Section({
  ...
  return (
    <section id={id} className={`section scroll-mt-24 py-16 sm:py-20 lg:py-28 ${className}`}>
      <Container>
