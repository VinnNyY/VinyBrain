...
import { navItems, site } from "@/lib/landing-content";
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-white/10 bg-[#0b0f19]/88 backdrop-blur-xl">
      <nav aria-label="Principal" className="mx-auto flex min-h-16 w-full max-w-7xl items-center justify-between px-5 sm:px-6 lg:min-h-[72px] lg:px-8">
        <a href="#topo" className="flex min-h-11 items-center gap-3 focus-ring">
          <Image
        ...
        <div className="hidden lg:block">
          <ButtonLink href="#lista" className="h-10 px-4 text-sm">
            Entrar na lista
          </ButtonLink>
        </div>
      ...
      >
        <div className="grid gap-2">
          ...
          <ButtonLink href="#lista" className="mt-2 w-full" >
            {site.ctaPrimary}
          </ButtonLink>
        </div>
      </div>
