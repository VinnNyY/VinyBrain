...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| PMN-083938 | Open | Suporte Técnico | Elementor Pro, Essential Addons | - | nao | - | - | NOT_TESTED | domínio não encontrado, link de acesso WordPress não encontrado | Revisar o ticket ou solicitar as informações faltantes. |
