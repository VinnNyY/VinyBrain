...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| QEY-565588 | - | - | - | - | nao | - | - | NOT_TESTED | domínio não encontrado, autorização não confirmada, plugin não identificado, link de acesso WordPress não encontrado | Revisar o ticket ou solicitar as informações faltantes. |
...
- Nenhum plano preparado.

## Preparacao de execucao

- Nenhuma preparacao de execucao.

## Tickets

| Ticket | Numero | Status | Departamento | Assunto | Plugins | Decisao | Prioridade | Motivo | Fonte |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| QEY-565588 | QEY-565588 | - | - | - | - | IGNORAR | ignorar | sem sinais suficientes de ativação de plugin | detail |
