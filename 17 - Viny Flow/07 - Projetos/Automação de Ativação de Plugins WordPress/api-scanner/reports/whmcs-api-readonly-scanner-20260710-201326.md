...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| QEY-565588 | Open | Suporte Técnico | Elementor Pro, WP Rocket | - | nao | - | - | NOT_TESTED | domínio não encontrado, autorização não confirmada, link de acesso WordPress não encontrado | Revisar o ticket ou solicitar as informações faltantes. |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| QEY-565588 | Elementor Pro | elementor-pro-4.0.1.zip | 4.0.1 | sim | NÃO INSTALADO | INSTALL_AND_ACTIVATE | REVIEW_REQUIRED | - | nao |
| QEY-565588 | WP Rocket | wp-rocket_3.22.0.3.zip | 3.22.0.3 | sim | NÃO INSTALADO | INSTALL_AND_ACTIVATE | REVIEW_REQUIRED | - | nao |
