...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| QEY-565588 | Open | Suporte Técnico | Elementor Pro, WP Rocket | providafisio.com.br | sim | temporary_login | providafisio.com.br | BROWSER_VALIDATION_FAILED | - | Revisar o motivo técnico da validação com navegador antes de concluir o acesso. |
