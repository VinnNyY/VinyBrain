...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| QEY-565588 | Open | Suporte Técnico | Elementor Pro, WP Rocket | providafisio.com.br | sim | temporary_login | providafisio.com.br | NOT_WORDPRESS | - | Validar cliente, serviço ativo, conta cPanel e instalação WordPress antes de qualquer ativação. |
