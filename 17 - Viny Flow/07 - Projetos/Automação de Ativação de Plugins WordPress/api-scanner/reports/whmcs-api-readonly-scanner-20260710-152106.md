...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| QEY-565588 | Open | Suporte Técnico | Elementor Pro, WP Rocket | providafisio.com.br | sim | temporary_login | providafisio.com.br | LOGIN_EXPIRED | - | Solicitar novo link temporário ao cliente e não abri-lo manualmente antes da validação automática. |
