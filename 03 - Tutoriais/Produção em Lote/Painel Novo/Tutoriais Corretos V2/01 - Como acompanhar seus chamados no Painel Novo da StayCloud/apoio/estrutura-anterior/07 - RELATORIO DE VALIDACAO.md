...
O arquivo `06 - PREVIEW FINAL.html` foi aberto no Google Chrome em modo headless. Título, textos, hierarquia, listas, três imagens e legendas foram renderizados. A captura está em `_VALIDAÇÕES GERAIS/preview-01-chamados.png`.
