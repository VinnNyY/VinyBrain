...
const canonicalSlug = 'logs-deploy-staycloud';
...
const excerpt = 'Aprenda a consultar o status e os logs do Deploy StayCloud, abrir o histórico de publicações e identificar sinais de sucesso ou falha no build.';
...
const images = [
  { file: '01-aplicacao-correta-sanitizado.png', alt: 'Aplicação correta selecionada para consultar logs do Deploy StayCloud', title: 'Aplicação correta no Cloud' },
  { file: '02-status-deploy-sanitizado.png', alt: 'Status pronto no Deploy StayCloud', title: 'Status pronto do deploy' },
  { file: '03-historico-execucao-sanitizado.png', alt: 'Histórico de deploys com publicação pronta na StayCloud', title: 'Histórico de deploys' },
  { file: '04-aba-logs-sanitizado.png', alt: 'Aba Logs do Deploy StayCloud', title: 'Aba Logs do Deploy StayCloud' },
  { file: '05-conteudo-logs-sanitizado.png', alt: 'Linha segura de log do Deploy StayCloud', title: 'Linha segura de log de build' },
  { file: '06-aplicacao-disponivel-sanitizado.png', alt: 'Botão Abrir para acessar aplicação publicada no Deploy StayCloud', title: 'Botão Abrir aplicação publicada' },
];
