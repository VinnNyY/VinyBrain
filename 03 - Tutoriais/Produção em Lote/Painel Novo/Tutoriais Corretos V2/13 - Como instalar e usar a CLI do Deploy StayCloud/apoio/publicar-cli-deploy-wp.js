...
const canonicalSlug = 'cli-deploy-staycloud';
const title = 'CLI DEPLOY STAYCLOUD';
const focusKeyword = 'CLI Deploy StayCloud';
const seoTitle = 'CLI Deploy StayCloud: como instalar e usar';
const metaDescription = 'Aprenda a instalar e usar a CLI Deploy StayCloud, conectar seu projeto e executar o comando de publicação com segurança.';
const excerpt = 'Veja como usar a CLI Deploy StayCloud pelo Painel Novo, gerar o comando oficial, conectar o projeto local e publicar pelo terminal.';
const socialTitle = 'Como instalar e usar a CLI do Deploy StayCloud';
const socialDescription = 'Conecte um projeto local ao Deploy StayCloud com a CLI oficial, publique pelo terminal e valide a URL gerada.';
const painelNovoCategoryId = 17;
const tagNames = ['Deploy', 'CLI', 'Terminal', 'Desenvolvimento', 'Aplicações', 'StayCloud'];

const images = [
  { file: '01-onde-obter-cli-sanitizado.png', alt: 'CLI Deploy StayCloud no card Deploy via CLI do Painel Novo', title: 'Card Deploy via CLI no Painel Novo' },
  { file: '02-comando-oficial-sanitizado.png', alt: 'Comando oficial da CLI Deploy StayCloud gerado no painel', title: 'Comando oficial da CLI Deploy StayCloud' },
  { file: '03-confirmacao-instalacao-sanitizado.png', alt: 'Comandos públicos da CLI Deploy StayCloud no terminal', title: 'Comandos públicos da CLI Deploy StayCloud' },
  { file: '04-autenticacao-conexao-sanitizado.png', alt: 'Conexão segura da CLI Deploy StayCloud no terminal', title: 'Conexão segura pelo terminal' },
  { file: '05-comando-deploy-sanitizado.png', alt: 'Comando de deploy pela CLI Deploy StayCloud', title: 'Comando de deploy pela CLI' },
  { file: '06-resultado-cli-sanitizado.png', alt: 'Resultado do deploy feito com a CLI Deploy StayCloud', title: 'Resultado do deploy pela CLI' },
];
...
async function main() {
  ...
  const payload = { title, content: publicHtml, excerpt, slug: canonicalSlug, status: 'draft', doc_category: [painelNovoCategoryId], doc_tag: tagIds };
