...
- Transcrição local executada com `mobiuslabsgmbh/faster-whisper-large-v3-turbo`, idioma `pt`, dispositivo `cpu`, `compute_type` `int8`, `beam_size` `5` e VAD ativo.
